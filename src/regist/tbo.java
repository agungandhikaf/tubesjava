 ...
 * @author LENOVO
 */
public class tbo extends javax.swing.JFrame {
Connection con =null;
Statement st = null;
ResultSet res = null;
    /**
     * Creates new form tbo
     */
    public tbo() {
        initComponents();
         load_table();
...
private void load_table(){
        ...
        try {
            int no=1;
            String sql = "select * from mktbo_soal";
    ...
    private void btnkirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnkirimActionPerformed
        ...
        try {
            ...
            int nilai = 0;
            String siqil = "select * from mktbo_soal";
            con=DriverManager.getConnection("jdbc:mysql://localhost/db_essay","root","");
            st=con.createStatement();
            ...
            String sql = "INSERT INTO mktbo_jawaban VALUES ('"+txtnama.getText()+"','"+txtnim.getText()+"','"+txtmk.getSelectedItem()+"','"+txtjawaban.getText()+"','"+nilai+"')";
            con = DriverManager.getConnection("jdbc:mysql://localhost/db_essay","root","");
            st = con.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tbo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
