 ...
 * @author LENOVO
 */
public class tbohasil extends javax.swing.JFrame {
Connection con =null;
Statement st = null;
ResultSet res = null;
    /**
     * Creates new form tbohasil
     */
    public tbohasil(){
        initComponents();
        load_table();
        ...
        try {
            int no=1;
            String sql = "select * from mktbo_jawaban";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tbohasil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
