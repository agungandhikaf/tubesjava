 ...
 * @author LENOVO
 */
public class tbodos extends javax.swing.JFrame {
 Connection con =null;
 Statement st = null;
    /**
     * Creates new form tbodos
     */
    public tbodos() {
        initComponents();
    }
    ...
    private void btnkirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnkirimActionPerformed
        ...
        try {
            String sql = "INSERT INTO mktbo_soal VALUES ('"+txtmk.getText()+"','"+txtsoal.getText()+"','"+kata1.getText()+"','"+kata2.getText()+"','"+kata3.getText()+"','"+kata4.getText()+"','"+kata5.getText()+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tbodos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
