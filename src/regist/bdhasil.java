 ...
 * @author LENOVO
 */
public class bdhasil extends javax.swing.JFrame {
Connection con =null;
Statement st = null;
ResultSet res = null;
    /**
     * Creates new form bdhasil
     */
    public bdhasil() {
        initComponents();
        load_table();
        ...
        try {
            int no=1;
            String sql = "select * from mkbd_jawaban";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bdhasil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
